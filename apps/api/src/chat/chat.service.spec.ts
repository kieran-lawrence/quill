...
import { ChatEntity, PrivateMessageEntity, UserEntity } from '@repo/api'
import { Repository } from 'typeorm'
import { Services } from '@repo/api'
import { CreateChatParams } from 'src/util/types'
...
describe('ChatService', () => {
    const MessageRepositoryToken = getRepositoryToken(PrivateMessageEntity)
    const ChatRepositoryToken = getRepositoryToken(ChatEntity)
    ...
    beforeEach(async () => {
        ...
        messageRepository = module.get<Repository<PrivateMessageEntity>>(
            MessageRepositoryToken,
        )
        chatRepository = module.get<Repository<ChatEntity>>(ChatRepositoryToken)
