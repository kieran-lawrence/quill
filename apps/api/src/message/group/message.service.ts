...
import { GroupMessageEntity, Services } from '@repo/api'
import { Repository } from 'typeorm'
import { GroupService } from '../../group/group.service'
import { CreateGroupMessageResponse, EditGroupMessageResponse } from '@repo/api'
import {
...
export class GroupMessageService {
    ...
    getGroupMessageById(id: number): Promise<GroupMessageEntity> {
